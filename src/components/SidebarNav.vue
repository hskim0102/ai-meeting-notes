...
const navItems = [
  ...
  { name: '회의목록(지식기반)', path: '/knowledge-meetings', icon: 'knowledge' },
]
  ...
  >
    ...
    <nav class="flex-1 p-2 space-y-1 overflow-y-auto" :class="isCollapsed && !isMobileOpen ? 'px-1.5' : 'px-3'">
      ...
      >
        ...
        <!-- Knowledge -->
        <svg v-if="item.icon === 'knowledge'" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
