...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '지식기반 회의', path: '/knowledge-meetings', icon: 'knowledge' },
    ],
  },
]
      ...
      <div v-for="group in navGroups" :key="group.label">
        ...
        <div class="space-y-0.5">
          ...
          >
            ...
            <!-- Knowledge 아이콘 -->
            <svg v-else-if="item.icon === 'knowledge'" class="w-4.5 h-4.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
